...
dat <- fread("genedata.ko00290.tsv", select = "kegg.names")
...
dat2 <- fread("genedata.ko00400.tsv", select = "kegg.names")
...
dat3 <- fread("ko00940.csv", select = "kegg.names")
...
dat6 <- fread("ko00073.csv", select = "kegg.names")
...
dat7 <- fread("ko00941.csv", select = "kegg.names")
...
dat8 <- fread("ko04146.csv", select = "kegg.names")
